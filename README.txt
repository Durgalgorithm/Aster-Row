...
APP_URL="https://ais-pre-ykonxqzxnvcb72zrwkaecz-304205435735.asia-east1.run.app"
```
...
| **Tool Use & Order Handling** | 6 | 6 | 100.0% |
| **Multi-Turn Context** | 2 | 2 | 100.0% |
| **Privacy & Injection Defense** | 3 | 3 | 100.0% |
| **Abstention & Human Handoff** | 2 | 2 | 100.0% |
...
[![Aster & Row AI Support Agent Demo](https://img.shields.io/badge/Demo%20Video-Watch%20Walkthrough-blue?style=for-the-badge&logo=youtube)](./demo/walkthrough.mp4)

> *Place your 2–4 minute screen recording at `demo/walkthrough.mp4` or link your hosted video here.*

### Covered Scenarios:
1. **Knowledge-Base Question with Citations**:
   - *Query*: `"What is your return policy window?"`
   - *Result*: Answers 30-day window for unused items with citation `[01-returns-policy-current.md#return-window]`.
...
3. **Multi-Turn Context Tracking**:
   ...
   - *Turn 2*: `"What about Canada?"` -> Retains international shipping context, provides $18 CAD flat rate and DDP duties explanation citing `06-international-shipping.md`.
4. **Refusal to Guess / Human Handoff**:
   - *Query*: `"Please cancel my in-transit order ORD-1007 and refund me right now."`
